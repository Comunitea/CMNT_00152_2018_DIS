...
class SaleOrder(models.Model):
    ...
    opt_prevention_risk = fields.Boolean(related='type_id.opt_prevention_risk',
                                   readonly=True)
    ...
    prevention_risk_contact_id  = fields.Many2one('res.partner',
    ...
    risk_document_completed = fields.Boolean(string='Risk document '
