odoo.define('website_base.comparison', function (require) {
'use strict';
...
// in website_sale.js
var SimulateProductComparison = Widget.extend(ProductConfiguratorMixin, {
    xmlDependencies: ['/website_base/static/xml/comparison.xml'],
...
sAnimations.registry.SimulateProductComparison = sAnimations.Class.extend({
    ...
    start: function () {
        ...
        this.SimulateProductComparison = new SimulateProductComparison(this);
        return $.when(def, this.SimulateProductComparison.appendTo(this.$el));
    },
    ...
    _onClickAddCompare: function (ev) {
        this.SimulateProductComparison.handleCompareAddition($(ev.currentTarget));
    },
    /**
     * @private
     * @param {Event} ev
