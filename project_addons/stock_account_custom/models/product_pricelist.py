...
class Pricelist(models.Model):
    ...
    def _compute_price_rule(self, products_qty_partner, date=False, uom_id=False):
        """
            Sobreescribimos para buscar por cost_ratio_id en la query
        """
        self.ensure_one()
        if not date:
        ...
        self._cr.execute(
            ...
            (prod_tmpl_ids, prod_ids, categ_ids, type_ids, self.id, date, date))
        # Añadimos tipos en la query
