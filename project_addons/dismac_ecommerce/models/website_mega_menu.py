...
class website_menu(models.Model):
    ...
    is_super_menu = fields.Boolean(string='Is Super Menu', default=False)
    is_top_menu = fields.Boolean(string='Is Top Menu', default=False)
    is_middle_menu = fields.Boolean(string='Is Middle Menu', default=False)
