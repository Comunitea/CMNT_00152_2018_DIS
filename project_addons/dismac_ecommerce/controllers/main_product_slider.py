...
class WebsiteSale(WebsiteSale):
    ...
    def get_products_content(self, **post):
        ...
        if post.get('tab_id'):
            ...
            return request.render("dismac_ecommerce.product_slider_content", {'product_collection':tab_data,'compute_currency': compute_currency,'limit' : post.get('limit') or 0,'full_width':post.get('full_width')})
        return ''
    ...
    def get_product_brand_slider(self, **post):
        ...
        return request.render("dismac_ecommerce.brand_slider_content", value)
    ...
    def get_product_latest_p(self,tab_id=0, **post):
        ...
        if tab_id:
            ...
            return request.render("dismac_ecommerce.latest_p_content", value)
    ...
    def get_multi_tab_content(self, **post):
        ...
        if post.get('collection_id'):
            ...
            return request.render("dismac_ecommerce.s_collection_configure", value)
    ...
    def multi_tab_product_snippet(self, **post):
        ...
        return request.render("dismac_ecommerce.product_tab_content", value)
    ...
    def product_slider_collection(self, **post):
        ...
        if post.get('collection_id'):
            ...
            return request.render("dismac_ecommerce.product_slider_2_content", value)
    ...
    def get_product_img_gallery(self, **post):
        ...
        if 'product_id' in post and post.get('product_id'):
            ...
            return request.render('dismac_ecommerce.product_image_gallery_content', value)
        return ''
