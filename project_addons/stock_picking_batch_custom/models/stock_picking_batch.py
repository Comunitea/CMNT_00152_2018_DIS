...
class BatchPickingGroupMove(models.Model):
    ...
    product_uom_qty = fields.Float(
        'Qty ordered', digits=dp.get_precision(
    ...
    def action_show_details(self):
        ...
        return {
            ...
            'context': dict(
                ...
                show_lots_text=move_id.has_tracking != 'none' and
                    self.batch_id.picking_type_id.use_create_lots and not
                    self.batch_id.picking_type_id.use_existing_lots,
...
class StockBatchPicking(models.Model):
    ...
    def _get_picking_type(self):
        for batch in self:
            batch.picking_type_id = batch.picking_ids and \
                batch.picking_ids[0].picking_type_id or False

    def get_move_done(self):

        data = self.env['report.stock_picking_batch_custom.report_batch_picking_custom']._get_grouped_data(self)
